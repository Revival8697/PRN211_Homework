    ...
    public partial class frmLogin : Form
    {
        ...
        private void PerformLogin()
        {
            try
            {
                ...
                else { MessageBox.Show("Wrong email or password", "Login Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
            }
            catch (Exception ex) { MessageBox.Show($"Error: {ex.Message}", "Login Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
